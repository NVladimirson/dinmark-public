					...
					<div class="row m-b-15">
						<div class="col-lg-12">
							<div class="pull-right">
								...
								<button type="submit" name="submit" value="order" class="btn btn-sm btn-green m-b-5 m-r-5" title="@lang('order.btn_new_order')"><i class="fas fa-file-pdf"></i></button>
                            ...
                            <div class="col-lg-6">
                                <div class="m-b-15">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <button type="submit" name="submit" value="import_product" class="btn btn-sm btn-green btn-block m-b-5" title="@lang('wishlist.import_product_btn')"><i class="fas fa-cloud-upload-alt"></i></button>
                                        </div>
                                    </div>
