				...
				<div class="panel-body">
					...
					<div class="row m-b-15">
						<div class="col-md-12">
							...
							<input class="form-control m-b-5" type="text" id="name" name="name" required value="{{$client->name}}">
						</div>
						<div class="col-md-12">
							<label for="phone">@lang('client.table_header_phone')</label>
							<input class="form-control m-b-5" type="tel" id="phone" name="phone" required value="{{$client->phone}}">
						</div>
						<div class="col-md-12">
							<label for="email">@lang('client.table_header_email')</label>
							<input class="form-control m-b-5" type="email" id="email" name="email" required value="{{$client->email}}">
						</div>
						<div class="col-md-12">
							<label for="company">@lang('client.table_header_company')</label>
							<input class="form-control m-b-5" type="text" id="company" name="company" value="{{$client->company_name}}">
						</div>
						<div class="col-md-12">
							<label for="edrpo">@lang('client.table_header_edrpo')</label>
							<input class="form-control m-b-5" type="text" id="edrpo" name="edrpo" value="{{$client->company_edrpo}}">
						</div>
						<div class="col-md-12">
							<label for="address">@lang('client.table_header_address')</label>
							<textarea class="form-control m-b-5" name="address" id="address" cols="30" rows="10" required>{{$client->address}}</textarea>
						</div>
					</div>
						<div class="row">
							<div class="col-lg-12">
