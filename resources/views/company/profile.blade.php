                        ...
                        @foreach($company->documents as $document)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="https://dinmark.com.ua/documents/{{$company->id}}/{{$document->folder}}/{{$document->document}}" class="btn btn-sm btn-primary m-r-10" target="_blank"><i class="fas fa-download"></i></a>
