                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="{{env('DINMARK_URL')}}documents/{{$company->id}}/{{$document->folder}}/{{$document->document}}" title="@lang('documents.download_button')" class="btn btn-sm btn-primary m-r-10" target="_blank"><i class="fas fa-download"></i></a> -->
																										<a href="https://dinmark.com.ua/documents/{{$company->id}}/{{$document->folder}}/{{$document->document}}" title="@lang('documents.download_button')" class="btn btn-sm btn-primary m-r-10" target="_blank"><i class="fas fa-download"></i></a>
